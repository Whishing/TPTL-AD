...
def main():
    ...
    pre_dict = torch.load("./last_model.pth")
    ...
    os.makedirs(os.path.join(args.save_path, 'prototype'), exist_ok=True)
    ...
    for class_name in mvtec.CLASS_NAMES:
        ...
        train_feature_filepath = os.path.join(args.save_path, 'prototype', 'train_%s.pkl' % class_name)
    ...
    print('Average pixel PRO: %.3f' % np.mean(total_pro_auc))
